              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-semibold text-primary-600 uppercase tracking-wider">{card.title}</span>
                  </div>
                  ...
                  <span className="inline-flex items-center gap-2 bg-primary-600 text-white font-semibold px-5 py-2.5 rounded-card text-sm hover:bg-primary-700 shadow-card transition-all duration-200">
                    {card.cta}
                  </span>
                </div>
              </Link>
