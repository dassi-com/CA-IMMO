...
export default function MobileAppPreview() {
  return (
    <section className="py-16 bg-primary-600 relative overflow-hidden">
      <div className="absolute inset-0 brand-pattern-light opacity-30 pointer-events-none" />
      <div className="container relative mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          {/* Left Content */}
          <div className="flex-1 text-white text-center lg:text-left">
            <h2 className="text-3xl font-extrabold mb-4">Get the best property alerts first.</h2>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <Link href="#" className="bg-secondary text-white px-6 py-2 rounded-card flex items-center gap-2 hover:bg-gray-800 shadow-card transition">
