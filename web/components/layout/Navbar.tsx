            ...
            {isAuthenticated ? (
              <Link
                ...
                className={`p-1.5 rounded-full transition ${
                  pathname === '/settings' ? 'text-red-600 bg-red-50' : 'text-gray-600 hover:text-red-600 hover:bg-red-50'
                }`}
              >
                <User size={20} />
              </Link>
          ...
          <div className="flex items-center space-x-4 md:hidden">
            ...
            {isAuthenticated ? (
              <Link
                href="/settings"
                className={`p-1.5 rounded-full transition ${
                  pathname === '/settings' ? 'text-red-600 bg-red-50' : 'text-gray-600 hover:text-red-600'
                }`}
              >
                <User size={20} />
              </Link>
